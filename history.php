...
<!DOCTYPE html>
<head>
<title>History | Ezekoconcept</title>
...
<table class="w3-table-all w3-hoverable">
    ...
    <?php $sql = "SELECT * FROM `wallet history` WHERE username='$username'";
$result = $conn->query($sql);
...
if ($result->num_rows > 0) {
   ...
   echo (   "<td>".  $row['service']."  ". $row['number']. " ".$row['data']. "</td>
