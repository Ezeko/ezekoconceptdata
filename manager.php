...
<!DOCTYPE html>
<head>
<title>Manager's Panel | Ezekoconcept</title>
		...
		<div class="market-updates">
			...
			<div class="col-md-3 market-update-gd">
				<div class="market-update-block clr-block-3">
					...
					<div class="col-md-8 market-update-left">
						<a href="airtime_update.php"><div class="col-md-8 market-update-left">
						<h4>Update Pending Airtime sales</h4>
							...
							<div class="agileits-box">
								<header class="agileits-box-header clearfix">
									<h3> <?php 
                                                                        ...
                                                                        if ($count>0){
                                                                        echo "<p class='w3-red'>PENDING DATA ORDER: $count <button class='w3-purple'><a href='admin_data.php'>view</a></button></p>";
                                                                        }
                                                                        else{
                                                                        echo "";}
                                                                        ...
                                                                        ?> </h3>
                                                                        <h3><?php 
                                                                        $sql="SELECT * FROM `airtime_history` WHERE status='PENDING'";
                                                                        $query= mysqli_query($conn, $sql) or die(mysqli_error($conn));
                                                                        $count= mysqli_num_rows($query);
                                                                        if ($count>0){
                                                                        echo "<p class='w3-red'>PENDING AIRTIME SALE: $count <button class='w3-blue'><a href='airtime_update.php'>view</a></button></p>";
                                                                        }
                                                                        else{
                                                                        echo "";}
                                                                        ...
                                                                        <h3><?php 
                                                                        $sql="SELECT * FROM `withdrawal_history` WHERE status='PENDING'";
                                                                        $query= mysqli_query($conn, $sql) or die(mysqli_error($conn));
                                                                        $count= mysqli_num_rows($query);
                                                                        if ($count>0){
                                                                        echo "<p class='w3-red'>PENDING DATA ORDER: $count <button class='w3-indigo'><a href='admin_data.php'>view</a></button></p>";
                                                                        }
                                                                        else{
                                                                        echo "";}
								...
								<div class="agileits-box-body clearfix">
									<div id="hero-area"></div>
                                                ...
                                                <a href="credit_user.php"><p class="w3-panel w3-center w3-grey">Credit user</p></a>
                                                  <a href="debit_user.php"><p class="w3-panel w3-center w3-grey">Debit user</p></a>
                                                     <a href="users.php"><p class="w3-panel w3-center w3-grey">All users</p></a>
                                                        <a href="airtime_update.php"><p class="w3-panel w3-center w3-grey">PENDING AIRTIME SALES</p></a>
                                                           <a href="admin_data.php"><p class="w3-panel w3-center w3-grey">Pending Data</p></a>
                                                              <a href="admin_withdraw_fund.php"><p class="w3-panel w3-center w3-grey">Pending Withdrawal</p></a>
                                                                 <a href="admin_wallet_history.php"><p class="w3-panel w3-center w3-grey">Wallet History</p></a>
                                                </div>
                                                                                               <div class="container">
