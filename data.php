...
<!DOCTYPE html>
<head>
<title>Buy Data | Ezekoconcept</title>
...
<section id="main-content">
	...
	<!--//agileinfo-grap-->
<div class="w3-panel w3-yellow w3-leftbar w3-border-pink">
	
	<p>Fill the form below to order for data plans. Please ensure you have enough <b>funds</b> in your account to carry out the transaction.</p>
	</div>
	
	<ul class='w3-ul w3-border'>
  <li><b>Network status</b></li>
   <li class='w3-container'>
    <div class='w3-quarter w3-padding w3-pale-yellow'>MTN: AVAILABLE</div>
    <div class='w3-quarter w3-padding w3-pink'>AIRTEL: AVAILABLE</div>
    <div class='w3-quarter w3-padding w3-green'>GLO: AVAILABLE</div>
    <div class='w3-quarter w3-padding w3-black'>9MOBILE: AVAILABLE</div>
  </li>
  </ul>

	<form action="validate_data.php" method="post" autocomplete = 'off'> 
	 <div class="w3-group">
	   ...
	   <div class="w3-group">
		...
		<select id="slct2" name = "slct2" class="w3-input w3-border"  required>		
		</select>
      </div> 
	  
	   <div class="w3-group">
        <label>Phone Number:</label>
        <input  class="w3-input w3-border" type="text" name="number" maxlength ="11" minlength = "11" required>
      </div>
	  
       
	  
      <button type="submit" class="w3-btn-block w3-padding-large w3-violet w3-margin-bottom">Buy Data</button>
    </form>  
...
<h1 class="w3-xxlarge w3-text-pink" style="text-align:center"><b>Order History.</b></h1><br />	
...
<tr class="w3-blue w3-hover-purple">
	...
	<td>
	<font face="Arial, Helvetica, sans-serif">Beneficiary</font>
	</td>
...
<tr class="w3-hover-indigo">
    <?php $sql = "SELECT * FROM `orders` WHERE username= '$username'";
$result = $conn->query($sql);
...
echo
	("<td><font face='Arial, Helvetica, sans-serif'>" . ($row['ord_date']). "</font></td>
	<td><font face='Arial, Helvetica, sans-serif'>" . ($row['network']). "</font>	</td>
		<td>	<font face='Arial, Helvetica, sans-serif'>". ($row['data']). "</font></td>
	<td>	<font face='Arial, Helvetica, sans-serif'>" .($row['amount']). "</font>	</td>
	<td>	<font face='Arial, Helvetica, sans-serif'>". ($row['number']). "</font>	</td>".
