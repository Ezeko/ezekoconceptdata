...
<!DOCTYPE html>
<head>
<title>Debit User | Ezekoconcept</title>
...
<body>
<?php if($_SESSION['username']!=='ezeko'){
...
if ($result->num_rows > 0) {
    ...
    echo "0 results";
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="mailto:info@ezekoconcept.dx.am">Inbox</a></li>
                        <li ><a href="htts://api.whatsapp.com/send?phone=2348188406153" >Contact us on whatsapp</a></li>
                    </ul>
                </li>
...
<section id="main-content">
	...
	<!--//credit-form-->
        ...
        <div class="w3-container w3-green" style="color:red">
        <br />
        <p class="w3-grey w3-text-xxlarge" style="text-align:center" > DEBIT USER</p>
	

	<form action="debit.php" method="post"  autocomplete = "off">
      ...
      <div class = "w3-group ">
       <label>Means of debit:</label>
        
        
		<select id="payment_means" name = "payment_means" class="w3-input w3-border w3-black "  required>
          ...
          <div class = "w3-group  " >
	   <label>Amount:</label>
        <input  class="w3-input w3-border w3-green payTog1" type="number" name="amount" placeholder="Amount to be debited" required>
      </div>
     
       <div class = "w3-group" >
	   <label>Remarks:</label>
        <input  class="w3-input w3-border w3-green" type="text" name="remarks" placeholder="Reason For the debit" required>
      </div>
      
    

	  
      <button type="submit" class="w3-btn-block w3-padding-large w3-orange w3-margin-bottom togMe3" >Confirm  Action</button>
        </div>
    </form>  
